...
export class CreateMechProductComponentDto {
  ...
  @ApiProperty({
    description:
      'Existing Component reference ID as a Holder (master or parent component). If ommited, this is a top level component',
    required: false,
  })
  readonly holderId?: number;

  @ApiProperty({
    description: 'Existing Component reference ID as a Child (child component)',
    required: true,
  })
